<template>
  <div class="bg-gray-900">
    <div class="relative isolate overflow-hidden pt-14">
      <img src="https://images.squarespace-cdn.com/content/55ef2d60e4b0659225f4aa25/1449698290103-6R0HPV7MQCOBSAGHWKEH/image-asset.jpeg?format=1500w&content-type=image%2Fjpeg" alt="" class="absolute inset-0 -z-10 h-full w-full object-contains" />
      ...
      <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        ...
        <div class="text-center">
          <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">RUNNING FIT APP</h1>
